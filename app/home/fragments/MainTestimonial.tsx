  ...
  return (
    <section className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <span className="inline-flex items-center rounded-full bg-brand/10 px-4 py-1 text-xs font-semibold tracking-wide text-brand-dark">
          FROM OUR LEADERSHIP
        </span>

        <Quote className="mt-8 h-10 w-10 text-brand/30" aria-hidden="true" />
        ...
        <blockquote className="mt-6">
          <TextAnimate
            ...
            duration={1.4}
            once
            className="text-2xl font-medium leading-relaxed tracking-tight text-navy sm:text-3xl lg:text-4xl"
          >
            {TESTIMONIAL_QUOTE}
          </TextAnimate>
        </blockquote>
